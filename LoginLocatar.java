...
public class LoginLocatar extends JFrame implements ActionListener {
	...
	public void verificaDate() {
		...
		if (ok == false) {
			...
			deschideFereastraLocatar(currentName);
			dispose();
		}
	...
	public void deschideLoginLocatar() {
		LoginLocatar loginAdmin = new LoginLocatar();
	...
	public void deschideSignUpLocatar() {
		var signUpAdmin = new SignUpLocatar();
	...
	public void deschideFereastraLocatar(String name) {
		var FL = new FereastraLocatar(name);
		FL.setBounds(300, 90, 400, 300);
		FL.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
		FL.setResizable(false);
		FL.setVisible(true);
	}

	public void setCurrentName(String nume) {
		this.currentName = nume;
	}
